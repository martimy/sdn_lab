...
def create_mininet_network():
    ...
    info("*** Adding links\n")
    net.addLink(s21, h1, 1)
    net.addLink(s21, h2, 2)
    net.addLink(s22, h3, 1)
    net.addLink(s22, h4, 2)
    net.addLink(s23, h5, 1)
    net.addLink(s23, h6, 2)
    net.addLink(s11, s21, 1, 3)
    net.addLink(s11, s22, 2, 3)
    net.addLink(s11, s23, 3, 3)
    net.addLink(s12, s21, 1, 4)
    net.addLink(s12, s22, 2, 4)
    net.addLink(s12, s23, 3, 4)
